...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	quatreSpeed := math.Pow(speedInMsec, 2)
	calories := ((walkingCaloriesWeightMultiplier*weight + (quatreSpeed/heightInM)*walkingSpeedHeightMultiplier*weight) * duration * minInH)
	return calories
}
